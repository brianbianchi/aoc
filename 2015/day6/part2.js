...
expect(getBrigthtness(["turn on 0,0 through 0,0"])).to.equal(1);
expect(getBrigthtness(["toggle 0,0 through 999,999"])).to.equal(2000000);

console.log(getBrigthtness(arr));